  ...
  flow: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `Após logar, vai aparecer a tela inicial. Clica no card <strong>"+ Novo projeto"</strong> pra começar.<br><img src="tutorial-img/flow-2-novo-projeto.png" alt="Card + Novo projeto no Flow" class="tut-img" loading="lazy" onerror="this.style.display='none'">`
      },
      {
